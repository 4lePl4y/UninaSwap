...
public class JFilterNSearchPane extends JPanel {
    ...
    public JFilterNSearchPane(Controller controller) {
     ...
     // FILTERS PANEL 
        ...
        filtersPanel.add(Box.createHorizontalStrut(200)); // Spaziatura tra i pannelli di filtro
        ...
        filtersPanel.add(Box.createHorizontalStrut(150)); // Spaziatura tra i pannelli di filtro
